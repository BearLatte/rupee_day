...
class ErrorAlertView: UIView {
    ...
    private lazy var container = {
        ...
        view.backgroundColor = UIColor(red: 246/255.0, green: 221/255.0, blue: 178/255.0, alpha: 1.000)
    ...
    private lazy var cancelBtn = {
        ...
        btn.setTitleColor(UIColor(red: 223/255.0, green: 151/255.0, blue: 85/255.0, alpha: 1.000), for: .normal)
    ...
    private lazy var okBtn = {
        ...
        btn.titleLabel?.font = UIFont.systemFont(ofSize: 20)
        btn.backgroundColor = UIColor(red: 223/255.0, green: 151/255.0, blue: 85/255.0, alpha: 1.000)
